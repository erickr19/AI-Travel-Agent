        ...
        <%-- form --%>
          <form id="saveItineraryForm" method="POST" action="edit">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="itinerary" rows="20" aria-describedby="itineraryBody" name="itinerary" maxlength="5000" required>${itinerary.getItinerary()}</textarea>
              <div id="itineraryHelp" class="form-text">Required. You'll be able to edit this later too.</div>
            </div>
            <%-- title --%>
            <div class="mb-3">
              <label for="title" class="form-label">Title</label>
              <input type="text" class="form-control" id="title" aria-describedby="itineraryTitle" name="title" maxlength="100" value="${itinerary.getTitle()}" required>
              <div id="titleHelp" class="form-text">100 character limit</div>
            </div>
            <%-- budget --%>
            <div class="mb-3">
              <label for="budget" class="form-label">Budget</label>
              <input type="number" class="form-control" id="budget" aria-describedby="itineraryBudget" name="budget" maxlength="6" value="${itinerary.getBudget()}" required>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="notes" aria-describedby="itineraryNotes" name="notes" maxlength="1000" value="${itinerary.getNotes()}">
